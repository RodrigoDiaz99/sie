        ...
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800" src="{{ asset('img/logo.png') }}">
            <div class="flex flex-col overflow-y-auto md:flex-row">
                ...
                <div class="h-60 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-fill h-full w-full bg-gray-500 dark:hidden" src="{{ asset('img/logo.png') }}" alt="prolifearmy" />
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block" src="{{ asset('img/logo.png')}}" alt="prolifearmy" />
                </div>
